(() => {
  ...
  var mrdocDiv = document.createElement("div");
  mrdocDiv.id = "mrdoc-clipper-div";
  mrdocDiv.mrclip = true;
  var mrdocIframe = document.createElement("iframe");
  ...
  function createInspector() {
    var coverDiv = (0, import_jquery.default)('<div id="mrdoc-clipper-mark-cover" mrclip></div>').css({
      position: "absolute",
      top: 0,
      left: 0,
      opacity: 0,
    ...
    var maskDiv = (0, import_jquery.default)('<div id="mrdoc-clipper-mark-mask" mrclip></div>').css({
      "border-radius": 5,
    ...
    var markDiv = (0, import_jquery.default)(
      '<div id="mrdoc-clipper-markcontainer" style="position:static;" mrclip></div>'
    );
    markDiv.appendTo((0, import_jquery.default)(document.body)).append(coverDiv).append(maskDiv);
  }
  (function() {
