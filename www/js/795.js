(globalThis["webpackChunkmrdoc_webclipper"] = globalThis["webpackChunkmrdoc_webclipper"] || []).push([[795],{
...
;// CONCATENATED MODULE: ./node_modules/@quasar/app-webpack/lib/webpack/loader.js.transform-quasar-imports.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@quasar/app-webpack/lib/webpack/loader.vue.auto-import-quasar.js??ruleSet[0].use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/pages/PopupPage.vue?vue&type=template&id=272a2140
...
;// CONCATENATED MODULE: ./src/pages/PopupPage.vue?vue&type=template&id=272a2140
...
/* harmony default export */ const PopupPagevue_type_script_lang_js = ({
  ...
  mounted() {
    ...
    document.querySelector(".EasyMDEContainer").addEventListener("paste", this.handlePaste, true); // 获取content-script发来的鼠标选择标记的网页内容
  ...
  methods: {
    ...
    async readConfig() {
      ...
      await this.mrdocClipperOptions.get(["mrdocUserToken"], r => {
        ...
        if (this.mrdocUrl != "" && this.mrdocUserToken != "") {
          this.$q.bex.send("getProjects", {
            ...
            // console.log(event);
            if (event.data.data) {
              this.projects = event.data.data; // this.$q.notify({
              //   message: "文集列表已更新！",
              //   icon: "info",
              //   position: "top",
              // });
      ...
      await this.mrdocClipperOptions.get(["defaultProject"], r => {
        this.selProject = r["defaultProject"];
      });
    ...
    // 获取网页标题+链接
    getPageTitleAndLink() {
      this.$q.bex.send("getPageTitleAndLink", {}).then(event => {
        console.log(event);
        this.title = event["data"]["title"];
    ...
    getPageBody() {
      this.loading = true;
      this.$q.bex.send("getPageBody", {}).then(event => {
        this.title = event.data.title;
          ...
          if (item.kind === "file") {
            ...
            reader.onload = function (event) {
              ...
              that.$q.bex.send("pasteImg", {
                ...
                // console.log("粘贴图片响应：", response);
                const payload = response.data;

                if (payload.status) {
                  const imgUrl = payload.data.startsWith("/") ? `${that.mrdocUrl}${payload.data}` : payload.data;

                  if (that.editorMode == "1") {
                    that.editor.codemirror.replaceSelection(`![](${imgUrl})\n`);
                  } else {
                    that.docContent += `<img src="${imgUrl}" />`;
                  }
                } else {
                  that.$q.notify({
